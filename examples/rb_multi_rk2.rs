...
use prestige::{
    ...
    setup_progress_bar, RK2Integrator, WriteOutput,
};
...
fn main() {
    ...
    let dir_name = project_root.to_owned() + "/rb_multi_rk2_output";
